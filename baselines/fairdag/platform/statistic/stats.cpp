...
void Stats::MonitorGlobal() {
  ...
  while (!stop_) {
    ...
    LOG(ERROR) << "=========== monitor =========\n"
               ...
               << " txn:" << (total_request - last_total_request) / monitor_sleep_time_
               << " total geo request:"
               << total_geo_request - last_total_geo_request
               << " total geo request per:"
               << (total_geo_request - last_total_geo_request) / monitor_sleep_time_
